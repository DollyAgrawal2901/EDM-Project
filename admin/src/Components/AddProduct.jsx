   ...
   return (
     <div className='box-border w-[55%] py-[30px] px-[50px] my-[20px] mx-[30px] rounded-[6px] bg-slate-300'>
        ...
        <div className='flex gap-[40px]'>
            <div className='w-[100%] text-black font-semibold text-[20px] px-[10px] py-[10px]'>
                <p>Price</p>
                <input value={productDetails.old_price} onChange={changeHandler}  className='box-border w-[100%] h-[50px] rounded-[4px] pl-[15px] border border-[#c3c3c3] outline-none text-[#7b7b7b] text-[14px]' type="text" name='old_price' placeholder='Type here'/>
            </div>
            <div className='w-[100%] text-black font-semibold text-[20px] px-[10px] py-[10px]'>
                <p>Offer Price</p>
                <input value={productDetails.new_price} onChange={changeHandler} className='box-border w-[100%] h-[50px] rounded-[4px] pl-[15px] border border-[#c3c3c3] outline-none text-[#7b7b7b] text-[14px]' type="text" name='new_price' placeholder='Type here'/>
            </div>
        </div>
        <div className='w-[100%] text-black font-semibold text-[20px] px-[10px] py-[10px]'>
